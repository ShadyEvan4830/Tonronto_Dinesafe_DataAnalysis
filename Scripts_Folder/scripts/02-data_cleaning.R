...
#### Clean data ####
raw_data <- read.csv("Inputs_Folder/Data/raw_data.csv")
...
#### Save data ####
write.csv(dataset, "Inputs_Folder/Data/Clean_Dinesafe_Data.csv")

#### Clean data ####
raw_data2 <- read.csv("Inputs_Folder/Data/raw_data2.csv")
...
#### Save data ####
write.csv(cpi_data, "Inputs_Folder/Data/Clean_CPI_Data.csv")
