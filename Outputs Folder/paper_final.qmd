...
dataset <- read_csv("Inputs Folder/Data/Clean_Dinesafe_Data.csv")
...
cpi_data <- read_csv("Inputs Folder/Data/Clean_CPI_Data.csv") %>%
...
file_path <- "Inputs Folder/Data/Clean_Dinesafe_Data.csv"
dataset <- read_csv(file_path)

processed_dataset <- dplyr::select(dataset, 
                                   Inspection_Dates = `Inspection Date`, 
...
summary_table <- dplyr::group_by(processed_dataset, Establishment_Type, Establishment_Status) %>%
  dplyr::summarise(Total_Count = n(), 
                   Avg_Min_Inspections = mean(Min_Inspections_Per_Year, na.rm = TRUE)) %>%
  dplyr::arrange(Establishment_Type, Establishment_Status)

#knitr::kable(summary_table)

kable(head(summary_table,20), format = "latex", longtable = TRUE, booktabs = TRUE) %>%
...
file_path <- "Inputs Folder/Data/Clean_CPI_Data.csv"
